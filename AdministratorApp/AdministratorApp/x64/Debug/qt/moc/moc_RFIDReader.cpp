...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RFIDReader_t, stringdata0) + ofs \
...
void RFIDReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onRFIDRead((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (RFIDReader::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RFIDReader::onRFIDRead)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RFIDReader::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_RFIDReader.data,
...
// SIGNAL 0
void RFIDReader::onRFIDRead(QString _t1)
{
